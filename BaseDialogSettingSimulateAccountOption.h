...
enum BaseDialogSettingSimulateAccountOptionIds
{
#ifndef TAKION_NO_OPTIONS
	groupAccountOptionId = baseSimulateAccountSymbolIdsCount,
	checkBoxAccountOptionId,
	radioAccountOptionCallId,
	radioAccountOptionPutId,
	comboBoxAccountOptionSuffixId,
	staticAccountOptionSuffixId,
	spinAccountOptionStrikePriceId,
	staticAccountOptionStrikePriceId,
	datetimeAccountOptionExpirationId,
	staticAccountOptionExpirationId,

	baseSimulateAccountOptionIdsCount
#else
	baseSimulateAccountOptionIdsCount = baseSimulateAccountSymbolIdsCount
#endif
};

class BaseDialogSettingSimulateAccountOption : public BaseDialogSettingSimulateAccountSymbol
{
public:
#ifndef TAKION_NO_OPTIONS
...
#endif
protected:
	BaseDialogSettingSimulateAccountOption(TakionMainWnd* mainWnd, TakionSettingTabDialog* parentTab, const char* label);
#ifndef TAKION_NO_OPTIONS
